...
python -u launch.py --command="python train_imagenet.py --config-file configs/simplevit/vitb_1000cls_advpyramid.yaml $CACHE --logging.project_name imgnet1K_simplevits_fb --logging.resume_id=fb_simplevits_test_ade --logging.folder outputs/simplevits/advpyramidcachetargeted_r6_advw0.1_reverse2ce --adv.cache_class_wise_targeted=1 --adv.adv_loss_weight=0.1 --adv.radius_input=0.04705882352 --adv.step_size_input=0.0094117647 --adv.cache_class_wise_targeted_loss=reverse_twologits_ce --adv.pyramid=1 --dist.world_size=16" &> job_log/run10-6.log &