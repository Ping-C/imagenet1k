...
python -u launch.py --command="python train_imagenet.py --config-file configs/simplevit/vitb_1000cls.yaml                                                                      --logging.project_name imgnt1K_simplevitb_v2 --logging.resume_id=simplevitb1000v2aa --logging.folder outputs/simplevits_1K_v2/baseline --dist.world_size=16" &> job_log/run2-2.log &
python -u launch.py --command="python train_imagenet.py --config-file configs/simplevit/vitb_1000cls_advpyramid.yaml        --adv.radius_input=0.04 --adv.step_size_input=0.04 --logging.project_name imgnt1K_simplevitb_v2 --logging.resume_id=simplevitb1000v2ab --logging.folder outputs/simplevits_1K_v2/advpyramid_r0.04_s0.04_c1 --dist.world_size=16" &> job_log/run2-3.log &
...
python -u launch.py --command="python train_imagenet.py --config-file configs/simplevit/vitb_1000cls_advpyramid.yaml $CACHE --adv.radius_input=0.06 --adv.step_size_input=0.012 --logging.project_name imgnt1K_simplevitb_v2 --logging.resume_id=simplevitb1000v2ac --logging.folder outputs/simplevits_1K_v2/advpyramidcache_r0.06 --dist.world_size=16" &> job_log/run2-4.log &
python -u launch.py --command="python train_imagenet.py --config-file configs/simplevit/vitb_1000cls_advpyramid.yaml $CACHE --adv.radius_input=0.08 --adv.step_size_input=0.016 --logging.project_name imgnt1K_simplevitb_v2 --logging.resume_id=simplevitb1000v2ad --logging.folder outputs/simplevits_1K_v2/advpyramidcache_r0.08 --dist.world_size=16" &> job_log/run2-5.log &

# experiment where only universal adversary is used and no clean examples are shown
python -u launch.py --command="python train_imagenet.py --config-file configs/simplevit/vitb_1000cls_advpyramid.yaml $CACHE --adv.radius_input=0.08 --adv.step_size_input=0.016 --adv.adv_loss_weight=1 --logging.project_name imgnt1K_simplevitb_v2 --logging.resume_id=simplevitb1000v2ae --logging.folder outputs/simplevits_1K_v2/advpyramidcachenoclean_r0.08 --dist.world_size=16" &> job_log/run2-6.log &
