...
python -u launch.py --command="python train_imagenet.py --config-file configs/simplevit/vitb_1000cls_advpyramid.yaml        --adv.radius_input=0.04705882352 --adv.step_size_input=0.04705882352 --logging.project_name imgnt1K_simplevitb_fb --logging.resume_id=fb_simplevitb_aab --logging.folder outputs/simplevitb/advpyramid_r6_s6_c1 --adv.num_steps=1 --dist.world_size=16" &> job_log/run7-1_v2.log &

python -u launch.py --command="python train_imagenet.py --config-file configs/simplevit/vitb_1000cls_advpyramid.yaml        --adv.radius_input=0.04705882352 --adv.step_size_input=0.02352941176 --logging.project_name imgnt1K_simplevitb_fb --logging.resume_id=fb_simplevitb_aac --logging.folder outputs/simplevitb/advpyramid_r6_s3_c2 --adv.num_steps=2 --dist.world_size=16" &> job_log/run7-2_v2.log &

python -u launch.py --command="python train_imagenet.py --config-file configs/simplevit/vitb_1000cls_advpyramid.yaml        --adv.radius_input=0.04705882352 --adv.step_size_input=0.0156862745 --logging.project_name imgnt1K_simplevitb_fb --logging.resume_id=fb_simplevitb_aad --logging.folder outputs/simplevitb/advpyramid_r6_s1_c5 --adv.num_steps=5 --dist.world_size=16" &> job_log/run7-3_v2.log &
