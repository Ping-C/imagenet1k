...
python -u launch.py --command="python train_imagenet.py --config-file configs/simplevit/vits_1000cls_advpyramid.yaml $CACHE --logging.project_name imgnet1K_simplevits_fb --logging.resume_id=fb_simplevits_aea --logging.folder outputs/simplevits/advpyramidcachetargeted_r6_advw0.5_reverse2ce --adv.cache_class_wise_targeted=1 --adv.adv_loss_weight=0.5 --adv.radius_input=0.04705882352 --adv.step_size_input=0.0094117647 --adv.cache_class_wise_targeted_loss=reverse_twologits_ce --adv.pyramid=1 --dist.world_size=16" &> job_log/run11-1.log &
